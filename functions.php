...
function qod_scripts() {
    ...
    // TODO add a custom javescript file
    wp_enqueue_script( 'qod-script', get_template_directory_uri() . '/build/js/custom.min.js', array('jquery'), '20151215', true );

    // TODO add a custom localized script
